...
function Loading() {
  return (
    <div className=' text-center  font-extrabold  border-primary border-8 bg-slate-200  '>
      ...
      <div className='p-4 mb-32 border-primary border-2 bg-yellow-300 rounded ' >
        <h1 className='p-4 text-4xl'>Welcome to my simulated card shop!</h1>
        <h1 className='text-7xl mt-10 text-red-600'>FAKE PRODUCT NOT REAL</h1>
        <h1 className='m-4 p-4 border-primary border-2 '>Step into a world of virtual card collecting and unleash your creativity! Here, you have the power to curate your dream collection of trading cards from your favorite TCG sets.</h1>
        <h1 className='m-4 p-4 border-primary border-2'>Embark on a thrilling journey through the realms of Pokemon and Magic cards, exploring the vast array of collectibles available to you.</h1>
