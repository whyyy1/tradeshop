...
function Login() {
  ...
  return (
    <div className='flex text-center flex-col text-3xl m-20 h-max bg-yellow-300'>
      <div className='p-4 mt-10 mb-24 border-primary border-2 rounded ml-52 mr-52 font-extrabold'>
      ...
      <div >
        <form className='flex flex-col' onSubmit={handleLogin}>
          <label>Email:</label>
          <input className='mb-5 text-center border-primary border-2 rounded ml-96 mr-96' type='Email' placeholder='email' />
          <label>Password:</label>
          <input className='mb-5 text-center border-primary border-2 rounded ml-96 mr-96' type='Password' placeholder='password' />
          <button className='border-primary border-2 rounded ml-96 mr-96 mt-10 mb-5'>Login</button>
        </form>
      </div>
